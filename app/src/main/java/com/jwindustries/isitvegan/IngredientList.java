...
public class IngredientList {
    public static List<Ingredient> getIngredientList(Context context) {
        ...
        List<Ingredient> ingredientList = Arrays.asList(
                ...
                new Ingredient(context, resources, R.string.ingredient_gum_arabic, IngredientType.VEGAN, R.string.ingredient_gum_arabic_info,"E414"),
                new Ingredient(context, resources, R.string.ingredient_ascorbate, IngredientType.VEGAN, R.string.ingredient_ascorbate_info,null),
                new Ingredient(context, resources, R.string.ingredient_ascorbic_acid, IngredientType.VEGAN, R.string.ingredient_ascorbic_acid_info,"E300"),
                new Ingredient(context, resources, R.string.ingredient_ascorbyl_palmitate, IngredientType.VEGAN, R.string.ingredient_ascorbyl_palmitate_info,"E304"),
                new Ingredient(context, resources, R.string.ingredient_astaxanthin, IngredientType.VEGAN, R.string.ingredient_astaxanthin_info,"E161j"),
                ...
                new Ingredient(context, resources, R.string.ingredient_cocoa_mass, IngredientType.VEGAN, R.string.ingredient_cocoa_mass_info,null),
                ...
                new Ingredient(context, resources, R.string.ingredient_calcium_ascorbate, IngredientType.VEGAN, R.string.ingredient_calcium_ascorbate_info,"E302"),
                new Ingredient(context, resources, R.string.ingredient_calcium_formate, IngredientType.VEGAN, R.string.ingredient_calcium_formate_info,"E238"),
                ...
                new Ingredient(context, resources, R.string.ingredient_calcium_lactate, IngredientType.VEGAN, R.string.ingredient_calcium_lactate_info,"E327"),
                ...
                new Ingredient(context, resources, R.string.ingredient_cholic_acid, IngredientType.NOT_VEGAN, R.string.ingredient_cholic_acid_info,"E1000"),
                new Ingredient(context, resources, R.string.ingredient_citranaxanthin, IngredientType.VEGAN, R.string.ingredient_citranaxanthin_info,"E161i"),
                new Ingredient(context, resources, R.string.ingredient_collagen, IngredientType.NOT_VEGAN, R.string.ingredient_collagen_info,null),
                new Ingredient(context, resources, R.string.ingredient_egg, IngredientType.NOT_VEGAN, R.string.ingredient_egg_info,null),
                new Ingredient(context, resources, R.string.ingredient_egg_yolk, IngredientType.NOT_VEGAN, R.string.ingredient_egg_yolk_info,null),
                new Ingredient(context, resources, R.string.ingredient_gelatin, IngredientType.NOT_VEGAN, R.string.ingredient_gelatin_info,"E441, E485"),
                ...
                new Ingredient(context, resources, R.string.ingredient_potassium_ascorbate, IngredientType.VEGAN, R.string.ingredient_potassium_ascorbate_info,null),
                ...
                new Ingredient(context, resources, R.string.ingredient_potassium_lactate, IngredientType.VEGAN, R.string.ingredient_potassium_lactate_info,"E326"),
                new Ingredient(context, resources, R.string.ingredient_potassium_nitrate, IngredientType.VEGAN, R.string.ingredient_potassium_nitrate_info,"E252"),
                ...
                new Ingredient(context, resources, R.string.ingredient_lysozyme, IngredientType.NOT_VEGAN, R.string.ingredient_lysozyme_info,"E1105"),
                new Ingredient(context, resources, R.string.ingredient_milk, IngredientType.DEPENDS, R.string.ingredient_milk_info,null),
                ...
                new Ingredient(context, resources, R.string.ingredient_formic_acid, IngredientType.VEGAN, R.string.ingredient_formic_acid_info,"E236"),
                new Ingredient(context, resources, R.string.ingredient_modal, IngredientType.VEGAN, R.string.ingredient_modal_info,null),
                new Ingredient(context, resources, R.string.ingredient_mono__and_diglycerides_of_fatty_acids, IngredientType.VEGAN, R.string.ingredient_mono__and_diglycerides_of_fatty_acids_info,"E471"),
                new Ingredient(context, resources, R.string.ingredient_musk, IngredientType.NOT_VEGAN, R.string.ingredient_musk_info,null),
                new Ingredient(context, resources, R.string.ingredient_sodium_ascorbate, IngredientType.VEGAN, R.string.ingredient_sodium_ascorbate_info,"E301"),
                new Ingredient(context, resources, R.string.ingredient_sodium_formate, IngredientType.VEGAN, R.string.ingredient_sodium_formate_info,"E237"),
                ...
                new Ingredient(context, resources, R.string.ingredient_sodium_lactate, IngredientType.VEGAN, R.string.ingredient_sodium_lactate_info,"E325"),
                new Ingredient(context, resources, R.string.ingredient_sodium_nitrite, IngredientType.VEGAN, R.string.ingredient_sodium_nitrite_info,"E250"),
                new Ingredient(context, resources, R.string.ingredient_nisin, IngredientType.DEPENDS, R.string.ingredient_nisin_info,"E234"),
                ...
                new Ingredient(context, resources, R.string.ingredient_violoxanthin, IngredientType.VEGAN, R.string.ingredient_violoxanthin_info,"E161e"),
                new Ingredient(context, resources, R.string.ingredient_vitamin_b12, IngredientType.VEGAN, R.string.ingredient_vitamin_b12_info,null),
                ...
                new Ingredient(context, resources, R.string.ingredient_zeaxanthin, IngredientType.VEGAN, R.string.ingredient_zeaxanthin_info,"E161h"),

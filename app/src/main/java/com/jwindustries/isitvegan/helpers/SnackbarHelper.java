...
public final class SnackbarHelper {
     ...
     *
     * @param snackbarView the view to pass to {@link Snackbar#make(View, int, int)}} which will be
     *                     used to find a suitable parent, which is a
     *                     {@link androidx.coordinatorlayout.widget.CoordinatorLayout}, or the window decor's content
